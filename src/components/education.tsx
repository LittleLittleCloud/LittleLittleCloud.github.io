...
const EducationItem: React.FC<EducationItemProps> = ({ school, degree, major, description, graduation, startDate, endDate }) => (
    <article className="mb-6 p-4 bg-primary/90 hover:bg-primary/50 rounded-lg">
      ...
      <div className="mt-2">
      <p className="font-semibold">{degree} in {major}</p>
